...
#include "myCompressibleInterPhaseTransportModel.H"

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::myCompressibleInterPhaseTransportModel::myCompressibleInterPhaseTransportModel
(
...
Foam::myCompressibleInterPhaseTransportModel::alphaEff() const
{
    if (twoPhaseTransport_)
    {
        return
...
Foam::myCompressibleInterPhaseTransportModel::divDevRhoReff
(
    volVectorField& U
) const
{
...
void Foam::myCompressibleInterPhaseTransportModel::correctPhasePhi()
{
    if (twoPhaseTransport_)
    {
        const volScalarField& rho1 = mixture_.thermo1().rho();
...
void Foam::myCompressibleInterPhaseTransportModel::correct()
{
    if (twoPhaseTransport_)
    {
